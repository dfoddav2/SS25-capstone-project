...
We have also created another, more harshly cleaned dataset that drops 30\% more data, but is better able to capture the more regular cars. The numerical columns of this datasset have much better distributions, as visible from the following boxplots.
...
First however, we decided to check the feature importance of the model, which was quite lifelike, with \textbf{make} and \textbf{car\_title} being the most important individual descriptors.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{./images/xgboost_feature_importance.png}
  \caption{XGBoost Feature Importance. Source: Own work}
...
TODO: Here we will describe the process of cleaning the prices more harshly, removing more outliers and the results we achieved with this approach.
