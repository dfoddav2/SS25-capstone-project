...
TODO: Here we will present the results for the XGBoost model.

Results:
Training Metrics:
MAE: 14683.8006, MSE: 948185353.4293, R2: 0.9617

Test Metrics:
MAE: 29770.0580, MSE: 5058389231.1106, R2: 0.7949
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{./images/xgboost_residuals_distribution.png}
